...
def create_left_prompt_starship [] {
    /usr/bin/starship prompt --cmd-duration $env.CMD_DURATION_MS | str trim
}
...
$env.PROMPT_COMMAND = {|| create_left_prompt_starship }
